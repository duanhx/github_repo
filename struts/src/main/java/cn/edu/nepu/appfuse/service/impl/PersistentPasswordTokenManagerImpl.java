...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see cn.edu.nepu.appfuse.service.impl.PasswordTokenManager#generateRecoveryToken(cn.edu.nepu.appfuse.model.User)
     */
    @Override
    ...
    /**
     * @see cn.edu.nepu.appfuse.service.impl.PasswordTokenManager#isRecoveryTokenValid(cn.edu.nepu.appfuse.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see cn.edu.nepu.appfuse.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
